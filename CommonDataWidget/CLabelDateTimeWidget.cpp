...
void CLabelDateTimeWidget::SetDataEnable(bool bEnable)
{
    m_pDateTimeEdit->setEnabled(bEnable);
    if(!bEnable)
    {
        m_pDateTimeEdit->setStyleSheet("background-color:rgba(200,200,200,200)");
    }
}
